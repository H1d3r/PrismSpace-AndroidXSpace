...
class SpaceChipsTest {
    ...
    @Test fun `chips contain only real spaces and selection flags are correct`() {
        val spaces = listOf(main(), dual(11, "双A"), dual(13, "双B"))
        val chips = spaceChips(spaces, selectedMain = false, selectedDualId = "space_13")
        assertEquals(
            listOf("main" to "主空间", "space_11" to "双A", "space_13" to "双B"),
